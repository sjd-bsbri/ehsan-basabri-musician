...
//             >
//               <iframe
//     src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d51543.89635679321!2d58.47726565!3d37.10859595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f6a61a0b3b4d45d%3A0x6b896c7384a4b2b!2sQuchan%2C%20Razavi%20Khorasan%20Province%2C%20Iran!5e0!3m2!1sen!2sde!4v1723641321764!5m2!1sen!2sde"
//                 width="100%"
//                 height="100%"
//                 style={{ border: 0 }}
//                 allowFullScreen
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 glass-effect rounded-lg text-white text-sm sm:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
                    placeholder="نام شما"
                    required
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 glass-effect rounded-lg text-white text-sm sm:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all resize-none"
                  placeholder="پیام شما..."
                  required
                />
              </div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full py-3 sm:py-4 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-lg text-white text-sm sm:text-base font-semibold flex items-center justify-center gap-2 sm:gap-3 hover:shadow-xl hover:shadow-yellow-500/25 transition-all"
              >
                <FiSend className="text-lg sm:text-xl" />
                ارسال پیام
              </motion.button>
            ...
            <div className="space-y-4 sm:space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-3 sm:gap-4 glass-effect rounded-xl p-4 sm:p-6 hover:bg-white/5 transition-all group"
                >
                  <div className="p-2.5 sm:p-3 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-lg group-hover:scale-110 transition-transform">
                    <info.icon className="text-lg sm:text-xl lg:text-2xl text-white" />
                  </div>
                  <div>
                    <h4 className="text-gray-400 text-xs sm:text-sm">{info.title}</h4>
