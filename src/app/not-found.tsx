...
const Turntable = () => {
  return (
    <div className="relative w-72 h-72 md:w-80 md:h-80 flex items-center justify-center">
      <div className="absolute w-full h-full bg-amber-500/10 rounded-full blur-3xl"></div>
      ...
      >
        ...
        <div className="absolute w-28 h-28 rounded-full bg-gradient-to-br from-yellow-500 to-amber-600 flex items-center justify-center shadow-inner">
          <FiDisc className="text-white/70 text-4xl" />
        </div>
        <div className="absolute w-4 h-4 rounded-full bg-gray-800 border-2 border-gray-500"></div>
      </motion.div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-200 overflow-hidden p-6">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-12">
          <Link href="/">
            <button className="group flex items-center justify-center px-8 py-3 bg-transparent border-2 border-amber-500 text-amber-400 font-bold rounded-full shadow-lg hover:bg-amber-500 hover:text-white hover:scale-105 transform transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-amber-400">
              <FiHome className="ml-2 transition-transform duration-300" />
              بازگشت به صفحه اصلی
            </button>
          </Link>
